    ...
    <div id="container">
      ...
      <div class="icon-grp">
        <div class="icon-grp-item">
          <router-link to="/home"><svg class="icon" xmlns="http://www.w3.org/2000/svg" height="24"
        ...
        <div class="icon-grp-item" v-if="userRole">
          <a>
...
export default {
  ...
  mounted() {
    ...
    if (this.getUserRole == 2 || this.getUserRole == 3) {
      this.userRole = true;
    }
  },
};
