...
#     @invalid_attrs %{status: nil, time: nil, description: nil}
...
#       valid_attrs = %{status: true, time: ~N[2023-10-23 09:17:00], description: "some description"}
...
#       clock = clock_fixture()
#       update_attrs = %{status: false, time: ~N[2023-10-24 09:17:00], description: "some updated description"}
